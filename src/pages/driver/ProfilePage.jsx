...
import { UserIcon, EnvelopeIcon, PhoneIcon, MapPinIcon, TruckIcon } from '@heroicons/react/24/outline';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl shadow-sm">
          <div className="px-6 py-8 border-b border-gray-200">
            ...
            <p className="mt-2 text-gray-600">Manage your driver account information</p>
          </div>
